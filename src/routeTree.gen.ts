...
const ApiCertificationsIndexServerRoute = ApiCertificationsIndexServerRouteImport.update({
  id: "/",
  path: "/",
  getParentRoute: () => ApiCertificationsServerRoute,
} as any);
const ApiCertificationsIdServerRoute = ApiCertificationsIdServerRouteImport.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => ApiCertificationsServerRoute,
} as any);
...
const ApiCertificationsServerRouteWithChildren = ApiCertificationsServerRoute._addFileChildren(
